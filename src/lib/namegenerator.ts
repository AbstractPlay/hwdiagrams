...
export const wng = (minSize = 3, maxSize = 5, sound: Sound = "random") => {
    ...
    const consonantsHardMid = consonantsHardStart
        .slice(0)
        .concat(["hm", "mbl", "rb", "rbl"]);
    const consonantsSoftMid = consonantsSoftStart
        .slice(0)
        .concat(["sm", "sn", "sr"]);

    const consonantsHardEnd = [
        "b",
        "c",
        "ck",
        "d",
